...
\sqrt{23}=4+\sqrt{23}-4=4+\frac 1 {\frac 1 {\sqrt{23}-4}}=4
...
conciseness, we use the notation \sqrt{23}=[4;(1,3,1,8)], to
...
Exactly four continued fractions, for N \le 13, have an odd
period.

How many continued fractions for N \le 10\,000 have an odd
period?
"""
