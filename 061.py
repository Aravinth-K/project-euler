...
Each polygonal type: triangle (P3,127=8128), square (P4,
91=8281), and pentagonal (P5,44=2882), is represented by a
...
numbers = [(key, value) for key in list(figurates.keys())
